...
def update_recommend_tab(request):
    ...
    if favorites_playlist.songs.exists():
        ...
        song_queries = Q()
        for song_name, genre in split_recommended:
        ...
        for song in recommended_song_objects:
            print(f"Song Title: {song.song_title}, Genre: {song.genre}")
